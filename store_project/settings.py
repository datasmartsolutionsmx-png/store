...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-38d-3#h3xm)_ml6j9nqu#3k5*x!zd@_lz4fh@nm^5li^y0doh+')
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'ventas', 'static'),  # ← Agregado para que encuentre el logo
]
